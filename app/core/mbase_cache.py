...
async def cargar_mbase(redis: Redis) -> int:
    """Carga Mbase desde Redis a memoria. Devuelve cuántos tipos de día se cargaron."""
    _mbase.clear()
...
def obtener_mbase(tipo_dia: str) -> np.ndarray:
    """
    Mbase del tipo de día indicado. Si no está cargada (no se sembró), devuelve una matriz de
    ceros: el sistema degrada con elegancia operando como si todo fuese residuo.
    """
